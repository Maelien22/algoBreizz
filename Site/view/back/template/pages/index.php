						...
						<ul>
							<li class="left clearfix">
								...
								<div class="chat-body clearfix">
									<div class="header">
										<strong class="primary-font">Antoine Deport</strong> <small class="text-muted">32 mins ago</small>
									</div>
									<p>
										Yo, c'est antoine je vous annonce la prochaine battledev mdr que du lourd au programme feat Thierry. Bisous les copains.
									</p>
								</div>
							</li>
